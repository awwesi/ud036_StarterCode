...
the_big_lebowski = media.Movie("The Big Lebowski",
                               "A story about a Los Angeles slacker and avid"
                               " bowler.",
                               "http://img.moviepostershop.com/the-big-"
                               "lebowski-movie-poster-1998-1010196337.jpg",
                               "https://www.youtube.com/watch?v=ngV0RBhGZmE",
                               1998)

# instance of class Movie
a_fish_called_wanda = media.Movie("A Fish Called Wanda",
                                  "A story about a gang of diamond thieves who"
                                  " double-cross one another to find stolen"
                                  " diamonds hidden by the gang leader.",
                                  "https://image.tmdb.org/t/p/"
                                  "w220_and_h330_bestv2/"
                                  "hkSGFNVfEEUXFCxRZDITFHVhUlu.jpg",
                                  "https://www.youtube.com/watch?v=dqAJUlSRCwo",
                                  1988)
# instance of class Movie
when_harry_met_sally = media.Movie("When Harry Met Sally",
                                   "The story follows the title characters"
                                   " from the time they meet just before"
                                   " sharing a cross-country drive, through"
                                   " twelve years of chance encounters in New"
                                   " York City.",
                                   "https://upload.wikimedia.org/wikipedia/en/"
                                   "thumb/1/1c/WhenHarryMetSallyPoster.jpg/"
                                   "220px-WhenHarryMetSallyPoster.jpg",
...
titanic = media.Movie("Titanic",
                      "The story of Titanic with two play characters who"
                      " are of different social classes. ",
                      "https://upload.wikimedia.org/wikipedia/en/"
                      "2/22/Titanic_poster.jpg",
...
movies = [goodfellas, the_big_lebowski, a_fish_called_wanda, when_harry_met_sally,
          titanic, wall_street]
